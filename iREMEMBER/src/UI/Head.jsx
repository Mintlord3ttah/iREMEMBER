...
export default function Head({children, heading}) {
  return <div className="flex gap-6 max-[490px]:gap-3 max-[845px]:justify-between border-b pb-4 border-b-amber-400 items-center mb-4 max-[780px]:px-12 max-[715px]:px-4">
